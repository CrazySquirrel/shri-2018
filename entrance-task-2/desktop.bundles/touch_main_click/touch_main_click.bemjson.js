({
    ...
    head : [
        ...
        { elem : 'css', url : 'touch_main_click.min.css' }
    ],
    scripts : [{ elem : 'js', url : 'touch_main_click.min.js' }],
    mods : { theme : 'islands' },
    content : [
        {
    		block : 'header',
		...
		},
		{
						...
						},
            {
							...
							content: {
								elem: 'cell',
								elemMods: { type: 'selected-touch' },
								content: {
									block: 'caption',
									content: [
										{
											elem: 'title',
											content: 'Рассуждения о высоком'
										},
										{
											elem: 'text',
											content: '14 декабря, 15:00—17:00  ·  Жёлтый дом'
										},
										{
											block: 'participants',
											content: [
												{
													block : 'image',
													mix: { block: 'participants', elem: 'image' },
								                	url : '../../img/darth.jpg',
								                	alt : 'Дарт Вейдер',
								                	width: 24,
								                	height: 24
												...
												{
													elem: 'others',
													content: 'и 12 участников'
												}
											]
										},
										{
											block: 'widget',
											mix: { block: 'caption', elem: 'widget' },
											content: {
												block: 'image',
												mix: { block: 'widget', elem: 'image' },
												mods: { edit: true },
